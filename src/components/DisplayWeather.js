    ...
    return (
        <div className="displayweather">
            ...
            <div className="maincard">
                ...
                <h1>
                    {Math.floor(1.8 * (data.main.temp -273) + 32)} 
                ...
                <div className="section1">
                    <table>
                        <tr>
                            ...
                            <td>
                                <span>
                                    {Math.floor(1.8 * (data.main.temp_max -273) + 32)} / {Math.floor(1.8 * (data.main.temp_min -273) + 32)} F
                                </span>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <span>
                                    {Math.round(data.visibility * 0.000621371)} Miles
                                </span>
                            </td>
                        </tr>
                ...
                <div className="section2">
                    <table>
                        <tr>
                            ...
                            <td>
                                <span>
                                    {Math.floor(data.wind.speed * 3.28084)} ft/sec
                                </span>
                            </td>
                        </tr>
